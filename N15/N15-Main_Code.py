...
nu=np.linspace(-10,10,100) #Define dimnesionless binding site density differsence
...
c=np.array([15]) #Define dimensionless minimum binding site concentration
...
phi_min=np.linspace(0.05,0.95,100) #Define interstitial porosity at liquid interface
